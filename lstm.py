...
def sgd(lr, tparams, grads, x, mask, y, cost):
    ...
    f_update = theano.function([lr], [], updates=pup,
                               name='sgd_f_update', allow_input_downcast=True)
...
def train_lstm(
        ...
        saveFreq=11100,  # Save the parameters after every saveFreq updates
        # *0

        maxlen=170,  # Sequence longer then this get ignored
    ...
    print"=========="
    print 'test %i'%len(test[1])
    print'=========='
    print 'train %i'%len(train[1])
    ...
    f_cost = theano.function([x, mask, y], cost, name='f_cost', allow_input_downcast=True)

    grads = tensor.grad(cost, wrt=tparams.values())
    f_grad = theano.function([x, mask, y], grads, name='f_grad', allow_input_downcast=True)
    ...
    print >> sys.stderr, ('Training took %.1f s' %
                          (end_time - start_time))
